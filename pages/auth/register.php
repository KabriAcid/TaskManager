...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center p-4">
    <div class="w-full max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-2xl grid md:grid-cols-2">
        ...
        <div class="p-8 md:p-12">
            ...
            <p class="text-gray-600 dark:text-gray-400 mb-6">Join TaskFlow to streamline your workflow.</p>
            ...
            <form id="register-form" class="space-y-5">
                ...
                <div class="relative">
                    ...
                    <input id="name" name="name" type="text" required class="w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500" placeholder="Full Name">
                </div>
                ...
                <div class="relative">
                    ...
                    <input id="email-address" name="email" type="email" autocomplete="email" required class="w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500" placeholder="Email address">
                </div>
                ...
                <div class="relative">
                    ...
                    <input id="password" name="password" type="password" autocomplete="new-password" required class="w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500" placeholder="Password (min 6 characters)">
                </div>
                ...
                <div class="text-sm text-center">
                    <p class="text-gray-600 dark:text-gray-400">Already have an account?
                        <a href="login.php" class="font-medium text-indigo-600 hover:underline">Login here</a>
                    </p>
                </div>
            </form>
        </div>
        ...
        <!-- Brand Panel -->
        <div class="hidden md:flex flex-col justify-center p-12 bg-gradient-to-br from-indigo-600 to-purple-700 text-white rounded-r-2xl">
            ...
            <h1 class="text-3xl font-bold mb-4">Start Your Journey</h1>
            <p class="text-indigo-200">
                Create your account to unlock powerful task management and reporting tools.
            </p>
        </div>
    </div>
</div>
